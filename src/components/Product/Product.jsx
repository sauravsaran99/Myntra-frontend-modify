...
export const Productjsx = () => {
  ...
  useEffect(() => {
    if (selectData === "HightoLow") {
      const dumydata = products.sort(
        (a, b) => Number(b.dprice) - Number(a.dprice)
      );
      // console.log(dumydata)
      dispatch(Product(dumydata));
    } else if (selectData === "LowtoHigh") {
      const dumydata = products.sort(
        (a, b) => Number(a.dprice) - Number(b.dprice)
      );
      // console.log(dumydata)
      dispatch(Product(dumydata));
    ...
    <>
      ...
      <div className="product">
        <div className="productfirst">
          <div className="firstclothing">
            Home / Clothing /{" "}
            <span className="boldspan">
              {gender == "men" ? "Men T-shirts" : "Kurtis For Women"}
            </span>
          </div>
          <div className="secondclothing">
            <span className="boldspan">
              {gender == "men" ? "T-shirts for Men" : "Kurtis For Women"}
            </span>
            - {products.length} items
          </div>
          <div className="bottomFilter">
            <div className="filter">
              <span className="boldspan">FILTERS</span>
            </div>
